...
def prespective_transform(image, screen_size = None):
    ...
    gray = cv2.bilateralFilter(gray, 11, 17, 17)  # 11  // 11 FRO OFFLINE MAY NEED TO TUNE TO 5 FOR ONLINE
    ...
    warp = exposure.rescale_intensity(warped, out_range=(0, 255))
    x, y, h, w = 5, 18, 40, 18
    crop = warp[y:y-h, x:x-w]
    return crop
...
#convert_object(cv2.imread('1.jpg'), isDebug=True)
